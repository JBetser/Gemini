...
class Client:
    ...
    def tickers(self):
        ...
        curl https://api.bitfinex.com/v1/tickers
        [{"mid":"8167.85","bid":"8166.5","ask":"8169.2","last_price":"8166.6","low":"7240.0","high":"8467.05998033","volume":"96966.90592992","timestamp":"1521424089.758817996","pair":"BTCUSD"},
        {"mid":"151.695","bid":"151.66","ask":"151.73","last_price":"151.71","low":"137.13","high":"158.74","volume":"346327.88969404","timestamp":"1521424089.759107644","pair":"LTCUSD"},
        {"mid":"0.018594","bid":"0.01859","ask":"0.018598","last_price":"0.01859","low":"0.018568","high":"0.019661","volume":"27629.89985057","timestamp":"1521424089.759382344","pair":"LTCBTC"},
        ...
        """
        data = self._get(self.url_for(PATH_TICKERS))

        # convert all values to floats
        return [self._convert_to_floats(ticker) for ticker in data]
    ...
    def _convert_to_floats(self, data):
        ...
        for key, value in data.items():
            data[key] = float(value) if key != 'pair' else value
